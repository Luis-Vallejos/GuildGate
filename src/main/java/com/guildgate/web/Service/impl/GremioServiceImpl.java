...
import com.guildgate.web.Service.IGremioService;
...
public class GremioServiceImpl implements IGremioService {
    ...
    private static final Logger LOGGER = Logger.getLogger(GremioServiceImpl.class.getName());

    @Inject
    GremioJpaController gpc;

    public GremioServiceImpl() {
