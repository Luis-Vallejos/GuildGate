 ...
 * @author Juan - Luis
 */
public class ParticipacionesExtraService implements IParticipacionesExtraService {

    private static final Logger LOGGER = Logger.getLogger(ParticipacionesExtraService.class.getName());

    @Inject
    ParticipacionesExtraJpaController pejc;

    public ParticipacionesExtraService() {
