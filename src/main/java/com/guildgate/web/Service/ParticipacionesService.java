 ...
 * @author Juan - Luis
 */
public class ParticipacionesService implements IParticipacionesService {

    private static final Logger LOGGER = Logger.getLogger(ParticipacionesService.class.getName());

    @Inject
    ParticipacionesJpaController pjc;

    public ParticipacionesService() {
