...
@Table(
        ...
        indexes = {
            @Index(name = "idx_avatar_gremio_nombre", columnList = "Nombre_Archivo")
        }
)
@Getter
@Setter
...
public class AvatarGremio implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "avatar_gremio_seq")
    @SequenceGenerator(name = "avatar_gremio_seq", sequenceName = "avatar_gremio_seq", allocationSize = 1)
    ...
    @JoinColumn(name = "avatar_gremio_id")
