...
public class AvatarGremio implements Serializable { 
    ...
    private AvatarGremio.OrigenArchivo origenArchivo;
    ...
    public AvatarGremio(long id, byte[] data, String nomArchivo, String tipoArchivo, OrigenArchivo origenArchivo, List<Gremio> listaGremios) {
        this.id = id;
        this.data = data;
